...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('user/assets/css/templatemo-574-mexant.css') }}">
...
<body>
  ...
  <div class="swiper-container" id="top">
    <div class="swiper-wrapper">
      ...
      <div class="swiper-slide">
        <div class="slide-inner" style="background-image:url({{asset('user/assets/images/slide-02.jpg')}})">
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                <div class="header-text">
      ...
      <div class="swiper-slide">
        <div class="slide-inner" style="background-image:url({{ asset('user/assets/images/slide-03.jpg') }})">
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                <div class="header-text">
      ...
      <div class="row">
        <div class="col-lg-7">
          <div class="left-image">
            <img src=" {{ asset('user/assets/images/calculator-image.png') }} " alt="">
          </div>
        </div>
        <div class="col-lg-5">
          <div class="section-heading">
          ...
          <div class="owl-testimonials owl-carousel" style="position: relative; z-index: 5;">
            <div class="item">
              ...
              <div class="right-image">
                <img src="{{ asset('user/assets/images/testimonials-01.jpg')}}" alt="">
              </div>
            </div>
            <div class="item">
              <i class="fa fa-quote-left"></i>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-2 col-sm-4 col-6">
          <div class="item">
            <img src="{{ asset('user/assets/images/client-01.png')}}" alt="">
          </div>
        </div>
        <div class="col-lg-2 col-sm-4 col-6">
          <div class="item">
