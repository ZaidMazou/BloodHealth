                                ...
                                <ul class="show-notification profile-notification">
                                    ...
                                    <li class="waves-effect waves-light">
                                        <form action="{{ route('logout')}}" method="post">
                                            @csrf
                                           <button type="submit" class=" btn btn-none"> <i class="ti-layout-sidebar-left"></i> Logout</button>
                                        </form>
                                    </li>
                                </ul>
                            </li>
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="pcoded-hasmenu">
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class=" ">
                                            <a href=" {{ route('admin.blood.index')}}" class="waves-effect waves-dark">
                                        ...
                                        <li class="{{ Route::is('admin.blood.create') ? 'active' : '' }}">
                                            <a href="{{ route('admin.blood.create')}}" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                        ...
                                        <li class=" ">
                                            <a href="{{ route('admin.blood.edit',Auth::user()->id)}}" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="{{ Route::is('admin.hoiptal.show') ? 'active' : '' }}">
                                    <a href="{{ route('admin.hopital.show',Auth::user()->id)}}" class="waves-effect waves-dark">
                            ...
                            @if (Auth::user()->admin === 1)
                                <ul class="pcoded-item pcoded-left-item">
                                    <li class="pcoded-hasmenu">
                                        ...
                                        <ul class="pcoded-submenu">
                                            <li class=" ">
                                                <a href="{{ route('admin.superadmin')}}" class="waves-effect waves-dark">
                                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                            ...
                                            <li class=" ">
                                                <a href="{{ route('admin.hopital.index')}}" class="waves-effect waves-dark">
                                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                            ...
                                            <li class=" ">
                                                <a href="{{ route('admin.hopital.create')}}" class="waves-effect waves-dark">
                                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
